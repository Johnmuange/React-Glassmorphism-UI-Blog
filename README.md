...
[View Live Demo](https://blog.3techagency.com)
...
git clone https://github.com/Johnmuange/React-Glassmorphism-UI-Blog

# 2. Navigate into repository
cd react-glassmorphism-ui-blog
...
module.exports = {
  siteMetadata: {
    title: `React-Glassmorphism-UI-Blog`,
    author: {
      name: `3techagency`,
      summary: `marketing automation agency`,
    },
    description: `A Minimal & Beautiful Gatsby Blog Starter With Nice Glassmorphism Ui.`,
    siteUrl: `https://blog.3techagency.com`,
    social: {
      twitter: `3techagency`,
    },
  },
